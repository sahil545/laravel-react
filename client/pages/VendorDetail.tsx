            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2 justify-start">
              <div className="flex gap-4">
                <div className="pt-1 flex-shrink-0">
                  <div className="w-5 h-10 rounded-lg bg-blue-100 flex items-center justify-center">
              ...
              {vendor.phone_number && (
                <div className="flex gap-4">
                  <div className="pt-1 flex-shrink-0">
                    <div className="w-5 h-10 rounded-lg bg-green-100 flex items-center justify-center">
              ...
              {vendor.address && (
                <div className="flex gap-4">
                  <div className="pt-1 flex-shrink-0">
                    <div className="w-5 h-10 rounded-lg bg-purple-100 flex items-center justify-center">
