        ...
        <div className="max-w-7xl mx-auto px-4 flex flex-wrap items-center justify-center gap-2">
          <div className="flex items-center justify-center gap-1">
            <svg className="w-[18px] h-[18px]" viewBox="0 0 18 18" fill="none">
              <path d="M17.5 9.5C17.5 8.469 17.3165 7.4805 16.98 6.566C16.75 9.2605 15.3135 10.6445 13.8125 10C12.4065 9.396 13.354 7.0415 13.424 5.918C13.542 4.0135 13.418 1.8335 9.9585 0.0209999C11.396 2.771 10.125 4.4795 8.792 4.5835C7.313 4.699 5.9585 3.3125 6.4585 1.0625C4.8395 2.2555 4.7925 4.2635 5.292 5.5625C5.813 6.9165 5.271 8.0415 4.0005 8.1665C2.5805 8.3065 1.7915 6.646 2.519 4C1.26 5.4825 0.5 7.4025 0.5 9.5C0.5 14.1945 4.3055 18 9 18C13.6945 18 17.5 14.1945 17.5 9.5Z" fill="#F4900C"/>
