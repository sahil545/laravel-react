...
export default function ComingSoonSection() {
  const products = [
    {
      image: "https://api.builder.io/api/v1/image/assets/TEMP/ec5a0af0776fde07eb60d29901eb761f44019d2e?width=1700",
      title: "Pointing finger T-Shirt",
    },
    {
      image: "https://api.builder.io/api/v1/image/assets/TEMP/eb67b967834d1ac85081d36cf4c3adf7ce8a1171?width=1700",
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="relative">
            ...
            <svg className="absolute -top-1 left-[167px] w-[95px] h-[29px]" viewBox="0 0 95 29" fill="none">
              <path d="M42.9032 3.30009C33.3692 6.89723 11.4409 16.5818 0 26.5431C28.9427 30.9704 88.4624 32.5199 95 3.30009C85.8064 0.809765 62.5161 -2.67669 42.9032 3.30009Z" fill="#EBD96B"/>
            </svg>
          </div>
